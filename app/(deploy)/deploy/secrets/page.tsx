...
import { SecretsGetStarted } from '@/components/get-started/secrets-content';
    ...
    <div className="flex flex-col h-full bg-gradient-to-br from-background via-background to-muted/20 font-sans">
      ...
      <div className="flex-1 overflow-auto p-4 md:p-6 relative">
        ...
        <div className="max-w-7xl mx-auto relative">
          {secrets.length === 0 ? (
            <div>
              <SecretsGetStarted onCreateSecret={handleCreateFirstSecret} />
            </div>
          ) : (
            <>
              {/* Header */}
        ...
        {/* Create Secret Dialog - Available globally */}
